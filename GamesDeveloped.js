var count = 0;
var StringLoc = "";
var TextArray = ["Escape The Nemesis","Angry Fish","Box Runner",  "Color Switch Clone",  "Fighter Planes", "Kiwi Eater"]
...
function ChangePictureLeft() {
    ...
    if (count < 6 && count >= 0) {
        ...
        if (count > 0) {
            ...
            document.getElementById("ds").innerHTML = TextArray[count - 1];
            document.getElementById("ds").setAttribute("href", LinkArray[count]);
            SlideShowAddition();
...
function SlideShowVideoAddition() {
